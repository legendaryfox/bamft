...
public void menuClickFunction(final View v) {
		...
		case R.id.menu_item_map_view:
			...
			Intent loadOpenTrucksMapIntent = new Intent(getBaseContext(), OpenTrucksMapActivity.class);
			loadOpenTrucksMapIntent.putExtras(timeBundle);
			startActivity(loadOpenTrucksMapIntent);
